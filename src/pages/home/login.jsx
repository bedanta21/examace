                ...
                <div className="w-4/12 h-5/6 bg-white/95 flex flex-col justify-between">
                    <div className='flex flex-row justify-between items-center p-3 border-b-2'>
                        ...
                        <div className='flex flex-row'>
                            <div className='text-xs text-blue-500'>Don't have a Account ? </div>
                    ...
                    <div className='p-5 flex flex-col justify-center items-center'>
                        ...
                        <div className='p-3 mt-1 w-1/2 bg-rose-500 rounded text-white font-extrabold text-center cursor-pointer' onClick={() => handleClick("/dashboard")}>Login</div>
                    </div>
                </div>
            </div>
        </div>
